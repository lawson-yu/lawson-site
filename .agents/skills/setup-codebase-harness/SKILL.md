...
**Harness engineering:** the model is fixed — what you engineer is the _scaffolding_
...
ask _"what capability is missing, and how do I make it legible and enforceable?"_
and add it.
...
docs/tests/CI, and the _implicit_ rules (buried in READMEs, PR comments, people's
...
- _Advanced:_ a local, ephemeral observability stack (queryable logs/metrics) for
